...
DEBUG.style.cssText = 'position:fixed;bottom:0;left:0;right:0;background:#111;color:#4ec9b0;font:11px monospace;padding:6px 12px;z-index:999;max-height:120px;overflow-y:auto;border-top:1px solid #2a2a2a;';
DEBUG.id = 'debug-log';
